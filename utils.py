...
async def set_commands(app):
    COMMANDS = [
        ...
        BotCommand("stats", "To Displays Statistics Of The Server And Bot (Admin Only)."),
        BotCommand("status", "get your earnings information."),
        BotCommand("account", "get your account information."),
    ]
