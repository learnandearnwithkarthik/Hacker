        ...
        buttons = [
            [
                ...
                InlineKeyboardButton(
                    "❌ Click To Disable" if user["is_header_text"] else "✅ Click To Enable",
            ...
            [
                ...
                InlineKeyboardButton(
                    "❌ Click To Disable" if user["is_footer_text"] else "✅ Click To Enable",
            ...
            [
                ...
                InlineKeyboardButton(
                    "❌ Click To Disable" if user["is_username"] else "✅ Click To Enable",
            ...
            [
                ...
                InlineKeyboardButton(
                    "❌ Click To Disable" if user["is_banner_image"] else "✅ Click To Enable",
...
async def set_commands(app):
    COMMANDS = [
        BotCommand("start", "To Check Bot Alive Or Not"),
        ...
        BotCommand("settings", "To Check Your Settings"),
        BotCommand("status", "To Get Your Earnings Information."),
        BotCommand("account", "To Get Your Account Information."),
        BotCommand("include_domain", "For Adding Included Domain."),
        BotCommand("exclude_domain", "For Adding Excluded Domain."),
        BotCommand("batch", "To Convert Link For Channel (Owner Only)."),
        BotCommand("logs", "To Get The Log Messages (Owner Only)."),
        BotCommand("restart", "Restarts Or Re-Deploys The Bot (Owner Only)."),
        BotCommand("ban", "To Ban User (Owner Only)."),
        BotCommand("unban", "To Unban User (Owner Only)."),
        BotCommand("info", "To Get User Info (Owner Only)."),
        BotCommand("stats", "To Displays Statistics Of The Server And Bot (Owner Only)."),
    ]
